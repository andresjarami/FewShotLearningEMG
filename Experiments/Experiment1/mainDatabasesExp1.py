...
# featureSet = 1
# ## people Nina5 (1-10) Cote(1-17) EPN(1-30) Capgmyo_dba(1-18) Capgmyo_dbc(1-10) Nina3 (1-11) Nina1 (1-27)
# startPerson = 1
# endPerson = 1
...
# # nameFile = None
# nameFile = 'examples/esperanza' + typeDatabase + '_FeatureSet_' + str(featureSet) + '_startPerson_' + str(
