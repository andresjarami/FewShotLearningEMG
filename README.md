...
This database should import to the folder [data](Databases/CollectedData/allUsers_data/data). In addition, the file [main](Databases/CollectedData/Detect_muscle_activity/main.m) 
